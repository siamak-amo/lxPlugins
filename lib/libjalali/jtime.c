 ...
 *
 *
 * [Jul 2026]:  modification of jstrftime() format interpretation.
 *  In this version, a few useless `standard format' sequences
 *  such as: %D, %V replaced with the Farsi version of some other
 *  existing format identifiers.
 *  Also some other useful Farsi formats introduced, e.g., %Y %Z.
 */
#include <stdio.h>
#include <string.h>
#include <stdbool.h>
    ...
    for (i=0; i<fmt_n && rb < (int)(max - 1); i++) {
        if (format[i] != '%') {
            ...
            case 'd':
                ...
                /* Equivalent to %d but in Farsi. (utf8) characters. */
            case 'D':
                jalali_to_farsi(_la, 100, 0, "۰", jtm->tm_mday);
            ...
            case 'x':
                ...
                /* The month as a decimal number  in Farsi. (utf8) */
            case 'X':
                jalali_to_farsi(_l1, 10, 2, "۰", jtm->tm_mon+1);
            ...
            case 'Y':
                ...
                /* Equivalent to %y in Farsi digits. */
            case 'z':
                tmp = ((jtm->tm_year) % 1000) % 100;
                jalali_to_farsi(_l1, 10, 2, "۰", tmp);
                snprintf(buf, MAX_BUF_SIZE, "%s", _l1);
              break;

                /* Equivalent to %Y in Farsi digits. */
            case 'Z':
                jalali_to_farsi(_l1, 10, 4, "۰", jtm->tm_year);
                snprintf(buf, MAX_BUF_SIZE, "%s", _l1);
                break;
...
size_t parse_jstr_flag(char* buf, size_t max, const char flag,
                       const struct jtm* jtm, const bool farsi)
{
    (void) max;
    char _l1[10];
    char _l2[10];
    ...
    switch (flag){
            ...
            case 'd':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, " ", jtm->tm_mday);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%02d", jtm->tm_mday);
            ...
            case 'H':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, "۰", jtm->tm_hour);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else 
                    snprintf(buf, MAX_BUF_SIZE, "%02d", jtm->tm_hour);
                break;
            ...
            case 'I':
                tmp = (jtm->tm_hour == 12) ? 12 : jtm->tm_hour % 12;
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, "۰", tmp);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%02d", tmp);
                break;
            ...
            case 'j':
                if(farsi){
                    jalali_to_farsi(_la, 100, 3, "۰", jtm->tm_yday + 1);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%03d", jtm->tm_yday + 1);
                break;
            ...
            case 'k':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, " ", jtm->tm_hour);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%2d", jtm->tm_hour);
                break;
            ...
            case 'm':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, "۰", jtm->tm_mon + 1);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%02d", jtm->tm_mon + 1);
                break;
            ...
            case 'M':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, "۰", jtm->tm_min);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%02d", jtm->tm_min);
                break;
            ...
            case 'S':
                if(farsi){
                    jalali_to_farsi(_la, 100, 2, "۰", jtm->tm_sec);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%02d", jtm->tm_sec);
                break;
            ...
            case 'u':
                if(farsi){
                    jalali_to_farsi(_la, 100, 1, "", jtm->tm_wday + 1);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%d", jtm->tm_wday + 1);
                break;
            ...
            case 'w':
                if(farsi){
                    jalali_to_farsi(_la, 100, 1, "", jtm->tm_wday);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%d", jtm->tm_wday);
                break;
            ...
            case 'Y':
                if(farsi){
                    jalali_to_farsi(_la, 100, 1, "", jtm->tm_year);
                    snprintf(buf, MAX_BUF_SIZE, "%s", _la);
                }else
                    snprintf(buf, MAX_BUF_SIZE, "%d", jtm->tm_year);
                break;
